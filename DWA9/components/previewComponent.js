...
export default class PreviewComponent extends HTMLElement {
  constructor(image, title, author, published, description) {
    ...
    // Create a shadow DOM to encapsulate component styles and structure
    const shadow = this.attachShadow({ mode: 'open' });

    // Create a template element for the component's structure and styles
    ...
    <dialog class="overlay" data-list-active open="false">
  ...
  // Add an event listener to the close button when the component is connected to the DOM
  connectedCallback() {
    this.shadowRoot.querySelector('[data-list-close]').addEventListener('click', this.toggleOverlay);
  }
...
// Define the custom element with the tag name 'preview-component'
