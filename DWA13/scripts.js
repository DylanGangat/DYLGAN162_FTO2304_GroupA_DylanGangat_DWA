...
const highestAndLowestPrices = products.reduce(
  (acc, cur) => {
    const price = Number.parseInt(cur.price, 10);
...
const result = `Highest: ${highestAndLowestPrices.highest.product}. Lowest: ${highestAndLowestPrices.lowest.product}. `;
